...
This document shows how to simulate some data and then re-estimate the MAP Bayes
estimates.  For clarity, just the optimization piece has been included in a 
separate doc [map_bayes_example.html](map_bayes_example.html).  
...
```{r,include=FALSE}
saveRDS(data, "map_bayes_data.RDS")
```
